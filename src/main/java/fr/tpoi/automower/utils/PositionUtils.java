...
public class PositionUtils {
  ...
  public static void isPositionValid(final Garden garden, final Automower automower)
      throws InvalidInitialPosition {
    if (automower.getY() < 0 || automower.getY() > garden.getMaxY() || automower.getX() < 0
        || automower.getX() > garden.getMaxX()) {
